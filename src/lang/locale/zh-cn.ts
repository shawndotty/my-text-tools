export default {
	...
	OPTION_REMOVE_ALL: "移除所有换行",
	SETTING_LB_STYLE: "换行风格：",
	OPTION_LB_AUTO: "自动（保持原风格）",
	OPTION_LB_LF: "LF（\\n）",
	OPTION_LB_CRLF: "CRLF（\\r\\n）",
	CHECKBOX_LB_MERGE_EMPTY: " 合并连续空行",
	BTN_RUN_LB: "执行换行处理",
	...
	MODAL_GENERATE_PROMPT_TITLE: "使用 AI 生成自定义提示词",
	MODAL_GENERATE_PROMPT_REQ_DESC:
		"描述您希望 AI 做什么（例如：“将文本总结为 3 个要点”，“翻译成正式的法语”）。",
	MODAL_GENERATE_PROMPT_REQ_PLACEHOLDER:
		"例如：“从文本中提取所有日期和时间，并按时间顺序排列。”",
	BTN_GENERATE_PROMPT_AI: "AI 生成提示词",
	TOOLTIP_GENERATE_PROMPT_AI: "根据您的需求生成系统提示词和用户提示词",
	MODAL_GENERATE_SCRIPT_TITLE: "使用 AI 生成自定义脚本",
	...
	NOTICE_RECORDING_STOPPED: "录制已停止。",
	NOTICE_RECORDING_CANCELLED: "录制已取消。",
	NOTICE_BATCH_ADDED: "操作已记录。",
	MODAL_SAVE_BATCH_TITLE: "保存快捷指令",
	MODAL_SAVE_BATCH_NAME: "快捷指令名称",
	MODAL_SAVE_BATCH_PLACEHOLDER: "输入此快捷指令的名称...",
	NOTICE_BATCH_SAVED: "快捷指令已保存。",
	BTN_SAVE_NEW_BATCH: "保存",
	BTN_APPLY_BATCH: "应用快捷指令",
	MODAL_APPLY_BATCH_TITLE: "应用快捷指令",
	MODAL_APPLY_BATCH_SELECT: "选择要应用的快捷指令：",
	NOTICE_NO_BATCHES: "没有保存的快捷指令。",
	BTN_APPLY: "应用",
	TOOLTIP_BATCH_SHORTCUT_ENABLE: "生成快捷命令",
	TOOLTIP_BATCH_SHORTCUT_DISABLE: "移除快捷命令",
	COMMAND_BATCH_RUN_NOTE: "运行快捷指令：{0}（当前笔记）",
	COMMAND_BATCH_RUN_SELECTION: "运行快捷指令：{0}（选区）",
	MENU_BATCH_SHORTCUTS_LABEL: "MyTextTools 快捷指令",
	...
	CONFIRM_BATCH_FOLDER_DESC:
		"确定要对文件夹中的 {1} 个文件运行快捷指令「{0}」吗？",
	BTN_DELETE: "删除",
	BTN_CANCEL: "取消",
	BTN_CONFIRM: "确认",
	CONFIRM_DELETE_BATCH: "确定要删除这个快捷指令吗？",
	NOTICE_BATCH_APPLIED: "快捷指令应用成功。",
	...
	NOTICE_PROMPT_BATCH_CREATED: "已基于提示词创建快捷指令。",

	// Edit Batch
	MODAL_EDIT_BATCH_TITLE: "编辑快捷指令",
	BTN_EDIT: "编辑",
	BTN_SAVE_CHANGES: "保存修改",
	BTN_SAVE_AS_NEW: "另存为新快捷指令",
	BTN_DISCARD: "放弃修改",
	BTN_CLOSE: "关闭",
	BTN_MOVE_UP: "上移",
	BTN_MOVE_DOWN: "下移",
	...
	NOTICE_BATCH_UPDATED: "快捷指令已更新。",
	NOTICE_BATCH_SAVED_AS_NEW: "快捷指令已另存为新文件。",
	NOTICE_BATCH_DELETED: "快捷指令已删除。",
	CONFIRM_DELETE_BATCH_TITLE: "删除快捷指令",
	CONFIRM_DELETE_BATCH_DESC: "确定要删除快捷指令“{0}”吗？",
	...
	BTN_EXPORT_BATCHES: "导出快捷指令",
	BTN_IMPORT_BATCHES: "导入快捷指令",
	NOTICE_BATCH_EXPORT_SUCCESS: "快捷指令导出成功。",
	NOTICE_BATCH_IMPORT_SUCCESS: "快捷指令导入成功。",
	NOTICE_BATCH_IMPORT_ERROR: "导入快捷指令失败：{0}",
	MODAL_EXPORT_BATCH_TITLE: "选择要导出的快捷指令",
