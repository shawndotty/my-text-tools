export default {
	...
	MODAL_SAVE_BATCH_TITLE: "保存批处理",
	MODAL_SAVE_BATCH_NAME: "批处理名称",
	MODAL_SAVE_BATCH_PLACEHOLDER: "输入此批处理的名称...",
	NOTICE_BATCH_SAVED: "批处理已保存。",
	BTN_SAVE_NEW_BATCH: "保存",
	BTN_APPLY_BATCH: "应用批处理",
	MODAL_APPLY_BATCH_TITLE: "应用批处理",
	MODAL_APPLY_BATCH_SELECT: "选择要应用的批处理：",
	NOTICE_NO_BATCHES: "没有保存的批处理。",
	BTN_APPLY: "应用",
	TOOLTIP_BATCH_SHORTCUT_ENABLE: "生成快捷命令",
	TOOLTIP_BATCH_SHORTCUT_DISABLE: "移除快捷命令",
	COMMAND_BATCH_RUN_NOTE: "运行批处理：{0}（当前笔记）",
	COMMAND_BATCH_RUN_SELECTION: "运行批处理：{0}（选区）",
	...
	// Edit Batch
	MODAL_EDIT_BATCH_TITLE: "编辑批处理",
	BTN_EDIT: "编辑",
	BTN_SAVE_CHANGES: "保存修改",
	BTN_SAVE_AS_NEW: "另存为新批处理",
	BTN_DISCARD: "放弃修改",
	BTN_CLOSE: "关闭",
	BTN_MOVE_UP: "上移",
	BTN_MOVE_DOWN: "下移",
