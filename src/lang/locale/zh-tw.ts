export default {
	...
	SETTING_REGEX_EXTRACT_RULE: "提取規則 (Regex):",
	SETTING_SEPARATOR: "結果分隔符:",
	OPTION_NEWLINE: "換行符",
	OPTION_HYPHEN: "連字符 (-)",
	OPTION_SPACE: "空格",
	BTN_RUN_REGEX_EXTRACT: "執行提取",
	...
	NOTICE_REGEX_EXTRACT_DONE: "已提取 {0} 項內容",
	NOTICE_REGEX_EXTRACT_ERROR: "正則提取出錯！",
	...
	MODAL_ICON_PICKER_TITLE: "選擇圖示",
	MODAL_ICON_PICKER_SEARCH_PLACEHOLDER: "搜尋圖示...",
	...
	MODAL_SAVE_BATCH_TITLE: "保存捷徑",
	MODAL_SAVE_BATCH_NAME: "捷徑名稱",
	MODAL_SAVE_BATCH_PLACEHOLDER: "輸入捷徑名稱...",
	NOTICE_BATCH_SAVED: "捷徑已保存。",
	MODAL_APPLY_BATCH_TITLE: "應用捷徑",
	MODAL_APPLY_BATCH_SELECT: "選擇要應用的捷徑:",
	BTN_APPLY: "執行",
	TOOLTIP_BATCH_SHORTCUT_ENABLE: "生成快捷命令",
	TOOLTIP_BATCH_SHORTCUT_DISABLE: "移除快捷命令",
	COMMAND_BATCH_RUN_NOTE: "運行捷徑：{0}（當前筆記）",
	COMMAND_BATCH_RUN_SELECTION: "運行捷徑：{0}（選區）",
	MENU_BATCH_SHORTCUTS_LABEL: "MyTextTools 捷徑命令",
	...
	CONFIRM_BATCH_FOLDER_DESC:
		"確定要對資料夾中的 {1} 個檔案運行捷徑「{0}」嗎？",
	NOTICE_BATCH_APPLIED: "捷徑已執行。",
	...
	NOTICE_PROMPT_BATCH_CREATED: "已基於提示詞創建捷徑。",
	...
	NOTICE_BATCH_UPDATED: "捷徑已更新。",
	NOTICE_BATCH_SAVED_AS_NEW: "捷徑已另存新檔。",
	NOTICE_BATCH_DELETED: "捷徑已刪除。",
	CONFIRM_DELETE_BATCH_TITLE: "刪除捷徑",
	CONFIRM_DELETE_BATCH_DESC: "確定要刪除捷徑 '{0}' 嗎？此操作無法撤銷。",
	...
	BTN_EXPORT_BATCHES: "匯出捷徑",
	BTN_IMPORT_BATCHES: "匯入捷徑",
	NOTICE_BATCH_EXPORT_SUCCESS: "捷徑匯出成功。",
	NOTICE_BATCH_IMPORT_SUCCESS: "捷徑匯入成功。",
	NOTICE_BATCH_IMPORT_ERROR: "匯入捷徑失敗：{0}",
	MODAL_EXPORT_BATCH_TITLE: "選擇要匯出的捷徑",
	BTN_EXPORT_SELECTED: "匯出選中項",
	BTN_SELECT_ALL: "全選",
	...
	NOTICE_SCRIPT_IMPORT_SUCCESS: "腳本匯入成功。",
	...
	"Update Source": "更新來源",
	"Choose where to check for updates": "選擇檢查更新的來源",
