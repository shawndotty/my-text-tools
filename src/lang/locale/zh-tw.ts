export default {
	...
	COMMAND_BATCH_RUN_NOTE: "運行批處理：{0}（當前筆記）",
	COMMAND_BATCH_RUN_SELECTION: "運行批處理：{0}（選區）",
	MENU_BATCH_SHORTCUTS_LABEL: "MyTextTools 批處理快捷命令",
	...
	NOTICE_BATCH_NOT_FOUND: "找不到該批處理。",
	...
	CONFIRM_DELETE_BATCH_TITLE: "刪除批處理",
